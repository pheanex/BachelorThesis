...
seen_links = {0: [0, 1, 3, 4], 1: [0, 1, 2, 3, 4, 5], 2: [1, 2, 4, 5], 3: [0, 1, 3, 4, 6, 7], 4: [0, 1, 2, 3, 4, 5, 6, 7, 8], 5: [1, 2, 4, 5, 7, 8], 6: [3, 4, 6, 7], 7: [3, 4, 5, 6, 7, 8], 8: [4, 5, 7, 8]}
...
robust_graph = tcca.calculate_backup_links(mst_graph, g)
time.sleep(2)
tcca.write_json(robust_graph, "/home/kmanna/autowdsstatus/autowds-graph.json")
time.sleep(2)
webbrowser.open("file:///home/kmanna/autowdsstatus/autowds-graph.html")

ca_mst_graph = tcca.calculate_caa_for_graph(mst_graph, g, [1,6,11])
time.sleep(2)
tcca.write_json(ca_mst_graph, "/home/kmanna/autowdsstatus/autowds-graph.json")
time.sleep(2)
webbrowser.open("file:///home/kmanna/autowdsstatus/autowds-graph.html")

ca_robust_graph = tcca.calculate_caa_for_graph(robust_graph, g, [1,6,11])
time.sleep(2)
