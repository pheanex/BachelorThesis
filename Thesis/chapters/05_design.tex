...
Subsequently a channel assignment is computed for this specific topology. As input we need a connected, undirected, weigthed graph.
  \begin{figure}[htbp]
    \centering
...
\section{Channel Assignment Algorithm}
  ...
  \begin{figure}[htbp]
    ...
    \caption{Network topology with red nodes highlighting a channel-group.}
    \label{fig:caa_algo}
  \end{figure}
