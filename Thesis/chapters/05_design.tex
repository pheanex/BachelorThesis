...
\newpage
	...
	\begin{figure}[h!]
	  ...
	  \caption{Expected throughput \ac{SNR}-values by Otsuki et al. \cite{expected_snr}. We assume to get the best possible throughput for a given \ac{SNR}, since 
...
\newpage
	...
	\label{fig:mst_calc_3}
      ...
      portraying edge (G, K) as the best edge (See Figure \ref{fig:mst_calc_3}).
