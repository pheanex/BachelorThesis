\chapter{Implementation}
  ...
  \section{Language of Choice}
    ...
    was already written in this language, python does have a few key advantages, we did not want to miss and want to list here.
	...
	in the native language C/C++ for our scenario, this will take more time and effort, which was not the focus of this work.
	...
	Additionally not having to to flash the firmware then into the \ac{WLC} was a great time saver as keeping the \ac{WLC} running and 
